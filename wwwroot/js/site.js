    ...
    let count = 1;
        ...
        $.each(characters, function(key, character) {
            ...
            if ((character.name.search(regex) != -1)) {
                ...
                output += '<div class="col-md-6"><p><strong>Origin:</strong> ' + character.origin + '<br/>';
                output += '<strong>Job:</strong> ' + character.job + '<br/>';
                output += '<strong>Age:</strong> ' + character.age + '</p></div>';
                output += '<div class="col-md-6"><p><strong>Race:</strong> ' + character.race + '<br/>';
                output += '<strong>Height:</strong> ' + character.height + 'm<br/>';
                output += '<strong>Weight:</strong> ' + character.weight + 'kg</p></div>';
                output += '<br/></div></div>';
