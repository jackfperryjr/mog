    ...
    public static class EmailSenderExtensions
    {
        public static Task SendEmailConfirmationAsync(this IEmailSender emailSender, string email, string password, string link)
        {
            return emailSender.SendEmailAsync(email, "Confirm Email",
                $"Thanks for helping out!<br/><br/>I've registered you at this email address.<br/><br/>Please confirm your account by clicking this <a href='{HtmlEncoder.Default.Encode(link)}'>link</a>. Your default password is <strong>" + password + "</strong> and I suggest you change it once you're logged in. You will currently have access to modifying data for monsters only. If you have any suggestions or questions feel free to email me.<br/><br/>Thanks again!<br/>Jack");
        }
